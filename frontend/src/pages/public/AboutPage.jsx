          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-md">
                Nexura Solutions is a leading IT company providing comprehensive technology solutions
                to help businesses achieve digital transformation and sustainable growth.
              </p>
            </div>
